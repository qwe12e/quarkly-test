...
import { Theme, Link, Image, Button, Text, Box, Icon, Hr } from "@quarkly/widgets";
...
export default (() => {
	return <Theme theme={theme}>
				...
				<StackItem width="50%" display="block" quarkly-title="Menu" md-width="25%">
					...
					<Components.BurgerMenu>
						<Override
							...
							padding="0px 0 0px 0"
						>
							<Override slot="item" text-align="center" md-padding="16px 40px 16px 40px" text-transform="uppercase" />
		...
		>
			...
			<Components.Test md-color="#fb0505" />
		</Section>
		<Components.Test2 />
		<Menu />
		<Section
